...
const routes: Routes = [
  { path: "", redirectTo: "auth", pathMatch: "full" },
  {
    ...
    children: [
      {
        path: "", loadChildren: () => import('../app/components/layout/auth-layout/auth-layout.module').then(
  ...
  },
  {
    ...
    children: [
      {
        path: "", loadChildren: () => import('../app/components/layout/authenticated-layout/authenticated-layout.module').then(
